package com.example.bunsanedthinking_springback.main;

import com.example.bunsanedthinking_springback.constants.EmployeeNums;
import com.example.bunsanedthinking_springback.controller.*;
import com.example.bunsanedthinking_springback.entity.accident.Accident;
import com.example.bunsanedthinking_springback.entity.accident.AccidentList;
import com.example.bunsanedthinking_springback.entity.accident.AccidentListImpl;
import com.example.bunsanedthinking_springback.entity.accidentHistory.AccidentHistory;
import com.example.bunsanedthinking_springback.entity.accidentHistory.AccidentHistoryList;
import com.example.bunsanedthinking_springback.entity.accidentHistory.AccidentHistoryListImpl;
import com.example.bunsanedthinking_springback.entity.compensationDetail.CompensationDetailList;
import com.example.bunsanedthinking_springback.entity.compensationDetail.CompensationDetailListImpl;
import com.example.bunsanedthinking_springback.entity.complaint.Complaint;
import com.example.bunsanedthinking_springback.entity.complaint.ComplaintList;
import com.example.bunsanedthinking_springback.entity.complaint.ComplaintListImpl;
...
import com.example.bunsanedthinking_springback.entity.contract.ContractListImpl;
import com.example.bunsanedthinking_springback.entity.contract.ContractStatus;
import com.example.bunsanedthinking_springback.entity.counsel.Counsel;
import com.example.bunsanedthinking_springback.entity.counsel.CounselList;
import com.example.bunsanedthinking_springback.entity.counsel.CounselListImpl;
...
import com.example.bunsanedthinking_springback.entity.customer.CustomerListImpl;
import com.example.bunsanedthinking_springback.entity.customer.Gender;
import com.example.bunsanedthinking_springback.entity.department.Department;
import com.example.bunsanedthinking_springback.entity.department.DepartmentList;
import com.example.bunsanedthinking_springback.entity.department.DepartmentListImpl;
import com.example.bunsanedthinking_springback.entity.depositDetail.DepositDetail;
import com.example.bunsanedthinking_springback.entity.depositDetail.DepositDetailList;
import com.example.bunsanedthinking_springback.entity.depositDetail.DepositDetailListImpl;
...
import com.example.bunsanedthinking_springback.entity.diseaseHistory.DiseaseHistoryListImpl;
import com.example.bunsanedthinking_springback.entity.employee.*;
...
import com.example.bunsanedthinking_springback.entity.endorsment.EndorsementListImpl;
...
import com.example.bunsanedthinking_springback.entity.family.FamilyListImpl;
...
import com.example.bunsanedthinking_springback.entity.insuranceMoney.InsuranceMoneyListImpl;
import com.example.bunsanedthinking_springback.entity.jointAcquisition.JointAcquisitionList;
import com.example.bunsanedthinking_springback.entity.jointAcquisition.JointAcquisitionListImpl;
...
import com.example.bunsanedthinking_springback.entity.officeSupply.OfficeSupplyListImpl;
import com.example.bunsanedthinking_springback.entity.partnerCompany.PartnerCompany;
import com.example.bunsanedthinking_springback.entity.partnerCompany.PartnerCompanyList;
import com.example.bunsanedthinking_springback.entity.partnerCompany.PartnerCompanyListImpl;
...
import com.example.bunsanedthinking_springback.entity.paymentDetail.PaymentDetailListImpl;
...
import com.example.bunsanedthinking_springback.entity.product.ProductListImpl;
...
import com.example.bunsanedthinking_springback.entity.recontract.RecontractListImpl;
import com.example.bunsanedthinking_springback.entity.reinsurance.ReinsuranceList;
import com.example.bunsanedthinking_springback.entity.reinsurance.ReinsuranceListImpl;
import com.example.bunsanedthinking_springback.entity.report.Report;
import com.example.bunsanedthinking_springback.entity.report.ReportList;
import com.example.bunsanedthinking_springback.entity.report.ReportListImpl;
...
import com.example.bunsanedthinking_springback.entity.revival.RevivalListImpl;
import com.example.bunsanedthinking_springback.entity.surgeryHistory.SurgeryHistory;
import com.example.bunsanedthinking_springback.entity.surgeryHistory.SurgeryHistoryList;
import com.example.bunsanedthinking_springback.entity.surgeryHistory.SurgeryHistoryListImpl;
...
import com.example.bunsanedthinking_springback.entity.termination.TerminationListImpl;
...
//					break;
//				}
//			} catch (NumberFormatException | NotExistException e) {
//				System.out.println("잘못된 정보를 입력하였습니다. 다시 입력해주세요.");
//			}
...
//	}
//
//	private void customerViewComplaint(Customer customer) throws NotExistException {
//		ArrayList<Complaint> complaintList = customerController.getAllComplaintsByCustomerId(customer.getId());
//		// 여기
//		int index = 0;
//		do {
...
//			result.add(customerController.getComplaintById(id));
//		} catch (NumberFormatException e) {
//			//
//		} catch (NotExistException e) {
...
//			int id = Integer.parseInt(scanner.next());
//			Complaint complaint = customerController.getComplaintById(id);
//			System.out.println("민원 번호 : " + complaint.getId() + " 민원 종류 : " + complaint.getComplaintType().getName()
//					+ " 제목 : " + complaint.getTitle() + " 등록 날짜, 시간 : " + complaint.getPostDate() + " 내용 : "
...
//	}
//
//	private void customerViewAccident(Customer customer) throws NotExistException {
//		try {
//			if (customerController.getContractByOneAutomobileId(id).getContractStatus() == ContractStatus.ContractRequesting) {
...
//            throw new RuntimeException(e);
//        }
//        ArrayList<Accident> accidentList = customerController.getAllAccidentByCustomerId(customer.getId());
//		int index = 0;
//		do {
//			System.out.println("\n=================");
...
//				accidentList = customerController.getAllAccidentByCustomerId(customer.getId());
//				break;
//			case 2:
...
//		try {
//			int id = Integer.parseInt(scanner.next());
//			result.add(customerController.getAccidentById(id));
//		} catch (NumberFormatException e) {
//			System.out.println("잘못된 정보를 입력하였습니다. 다시 입력해주세요.");
//		} catch (NotExistException e) {
...
//		ArrayList<Insurance> insuranceList = customerController.getAllInsurance();
//		int index = 0;
//		do {
//			System.out.println("\n=================");
...
//		ArrayList<Insurance> result = customerController.getAllInsurance();
//		System.out.println("1. 질병 2. 상해 3. 자동차");
//		try {
//			int index = Integer.parseInt(scanner.next());
//			switch (index) {
//			case 1:
//				result = customerController.getAllDiseaseInsurance();
//				break;
//			case 2:
//				result = customerController.getAllInjuryInsurance();
//				break;
//			case 3:
//				result = customerController.getAllAutomobileInsurance();
//				break;
//			}
//		} catch (NumberFormatException e) {
//			//
...
//		try {
//			int id = Integer.parseInt(scanner.next());
//			result.add(customerController.getInsuranceByProductId(id));
//		} catch (NumberFormatException e) {
//			//
//		} catch (NotExistException e) {
...
//			input = scanner.next();
//			id = Integer.parseInt(input);
//			Insurance insurance = customerController.getInsuranceByProductId(id);
//			System.out.println("\n=================");
...
//		ArrayList<Loan> loanList = customerController.getAllLoan();
//		int index = 0;
//		do {
...
//		ArrayList<Loan> result = customerController.getAllLoan();
//		System.out.println("1. 담보 2. 정기 예금 3. 보험 계약");
//		try {
//			int index = Integer.parseInt(scanner.next());
//			switch (index) {
//			case 1:
//				result = customerController.getAllCollateralLoan();
//				break;
//			case 2:
//				result = customerController.getAllFixedDepositLoan();
//				break;
//			case 3:
//				result = customerController.getAllInsuranceContractLoan();
//				break;
//			}
//		} catch (NumberFormatException e) {
//			//
...
//		try {
//			int id = Integer.parseInt(scanner.next());
//			result.add(customerController.getLoanByProductId(id));
//		} catch (NumberFormatException e) {
//			//
//		} catch (NotExistException e) {
...
//			input = scanner.next();
//			id = Integer.parseInt(input);
//			Loan loan = customerController.getLoanByProductId(id);
//			System.out.println("");
...
//		try {
//			contractList = customerController.getAllApprovedByCustomer();
//		} catch (NotExistContractException e) {
...
//					Insurance product = customerController.getInsuranceByProductId(contract.getProduct().getId());
...
//	}
//
//	private ArrayList<Contract> getInsuranceType(Customer customer) throws NotExistContractException, NotExistException {
//		System.out.println("1. 자동차 보험 2. 상해 보험 3. 질병 보험");
//		int index = Integer.parseInt(scanner.next());
//		ArrayList<Contract> result = customerController.getAllContractByCustomerId(customer.getId());
//		switch (index) {
//		case 1:
//			result = customerController.getAllAutomobileInsuranceContract();
//			break;
//		case 2:
//			result = customerController.getAllInjuryInsuranceContract();
//			break;
//		case 3:
//			result = customerController.getAllDiseaseInsuranceContract();
//			break;
//		}
//		return result;
//	}
...
//			int id = Integer.parseInt(scanner.next());
//			ArrayList<Contract> contract = customerController.getAllContractByProductId(id);
...
//		try {
//			Contract contract;
//			contract = customerController.getContractById(id);
//			// 여기
...
//		ArrayList<InsuranceMoney> insuranceMoneyList = compensationController.getAllInsuranceMoney(this.insuranceMoneyList);
//		// 여기
//		int index = 0;
//		do {
//			System.out.println("\n=================");
...
//				insuranceMoneyList = compensationController.getAllInsuranceMoney(this.insuranceMoneyList);
//				break;
//			}
//		} while (1 <= index && index <= 3);
//	}
...
//		ArrayList<InsuranceMoney> result = compensationController.getAllInsuranceMoney(this.insuranceMoneyList);
//		// 여기
//		System.out.println("1. 미처리 2. 처리 완료");
//		int index = Integer.parseInt(scanner.next());
//		switch (index) {
//		case 1:
//			result = compensationController.getAllUnprocessedInsuranceMoney(this.insuranceMoneyList);
//			break;
//		case 2:
//			result = compensationController.getAllProcessedInsuranceMoney(this.insuranceMoneyList);
//			break;
//		}
//		return result;
//	}
...
//			System.out.println("ID 검색창 : ");
//			int index = Integer.parseInt(scanner.next());
//			InsuranceMoney insuranceMoney = compensationController.getInsuranceMoneyById(this.insuranceMoneyList, index);
//			// 여기
...
//		Customer customer;
//		try {
//			contract = compensationController.getContractById(this.contractList, insuranceMoney.getContractId());
//			// 여기
//			customer = compensationController.getCustomerById(this.customerList, contract.getCustomerID());
//			// 여기
//		} catch (NotExistException e) {
//			System.out.println("고객 " + e.getMessage());
//			return;
...
//		ArrayList<Report> reportList = compensationController.getAllReport(this.reportList);
//		// 여기
//		int index = 0;
//		do {
//			System.out.println("\n=================");
...
//			int index = Integer.parseInt(scanner.next());
//			Report report = compensationController.getReportById(this.reportList, index);
//			// 여기
...
//			int index = Integer.parseInt(scanner.next());
//			Report report;
//			report = compensationController.getReportById(this.reportList, index);
//			// 여기
//			result.add(report);
//		} catch (NotExistException e) {
//			System.out.println(e.getMessage());
...
//		ArrayList<Report> result = compensationController.getAllReport(this.reportList);
//		// 여기
//		System.out.println("1. 미처리 2. 처리 완료");
//		int index = Integer.parseInt(scanner.next());
//		switch (index) {
...
//		Customer customer;
//		try {
//			contract = compensationController.getAutomobileByCustomerId(this.contractList, report.getAccident().getCustomerID());
//			// 여기
//			customer = compensationController.getCustomerById(this.customerList, report.getAccident().getCustomerID());
//		} catch (NotExistContractException | NotExistException e) {
//			System.out.println(e.getMessage());
//			return;
//		}
...
//		int index = 0;
//		ArrayList<Complaint> complaintList = (ArrayList<Complaint>)customerSupportController.getAllComplaints();
//		// 여기
//		do {
//			try {
//				for (Complaint complaint : complaintList) {
//					Customer customer = customerSupportController.getCustomerById(complaint.getCustomerID());
...
//		ArrayList<Complaint> result = (ArrayList<Complaint>)customerSupportController.getAllComplaints();
//		// 여기
//		System.out.println("1. 미처리 2. 처리 완료");
//		int index = Integer.parseInt(scanner.next());
//		switch (index) {
//		case 1:
//			result = (ArrayList<Complaint>)customerSupportController.getAllUnprocessedComplaint();
//			break;
//		case 2:
//			result = (ArrayList<Complaint>)customerSupportController.getAllProcessedComplaint();
//			break;
//		}
//		return result;
//	}
...
//			System.out.print("ID 검색창 : ");
//			int index = Integer.parseInt(scanner.next());
//			Complaint complaint = customerSupportController.getComplaintById(index);
//			// 여기
...
//		Customer customer;
//		try {
//			customer = customerSupportController.getCustomerById(complaint.getCustomerID());
//			// 여기
//		} catch (NotExistException e) {
//			System.out.println(e.getMessage());
//			return;
...
//	}
//
//	private ArrayList<Accident> getStatusAccident() throws NotExistException {
//		ArrayList<Accident> result = (ArrayList<Accident>)customerSupportController.getAllAccidents();
//		// 여기
//		System.out.println("1. 미처리 2. 처리 완료");
//		int index = Integer.parseInt(scanner.next());
//		switch (index) {
//		case 1:
//			result = (ArrayList<Accident>)customerSupportController.getAllAccidentUnprocessedReport();
//			break;
//		case 2:
//			result = (ArrayList<Accident>)customerSupportController.getAllAccidentCompletedReport();
//			break;
//		}
//		return result;
//	}
...
//			int index = Integer.parseInt(scanner.next());
//			Accident accident;
//			accident = customerSupportController.getAccidentById(index);
//			// 여기
//			result.add(accident);
//		} catch (NotExistException e) {
//			e.printStackTrace();
...
//			int index = Integer.parseInt(scanner.next());
//			Accident accident = customerSupportController.getAccidentById(index);
//			// 여기
