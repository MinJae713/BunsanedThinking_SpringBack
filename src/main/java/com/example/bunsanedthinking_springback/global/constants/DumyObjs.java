...
public class DumyObjs {
	public static final Customer[] DUMY_CUSTOMERS = {
		new Customer("카즈하", "010-1112-1112", "대학생", 27, Gender.Female, "111111-1111111", "서대문구", 10000L, "신한",
			"1012-215-225937"),
		new Customer("장원영", "010-2223-2223", "유튜버", 23, Gender.Female, "222222-2222222", "송파구", 40000L, "우리",
			"1012-215-225937"),
		new Customer("권은비", "010-3334-3334", "물총장수", 25, Gender.Female, "333333-3333333", "마포구", 30000L, "국민",
			"1012-215-225937"),
		new Customer("이강인", "010-4445-4445", "축구선수", 23, Gender.Male, "444444-4444444", "종로구", 45000L, "하나",
			"1012-215-225937"),
		new Customer("오소름", "010-5556-5556", "영업사원", 42, Gender.Male, "555555-5555555", "강남구", 50000L, "우리",
			"1012-215-225937"),
		new Customer("최그램", "010-6667-6667", "파티플래너", 56, Gender.Male, "666666-6666666", "상록구", 25000L, "국민",
			"1012-215-225937")
	};
	...
	public static final PartnerCompany[] DUMY_PARTNER_COMPANIES = {
		new PartnerCompany("저스티스리그", "010-2583-6914", PartnerCompanyType.RoadsideAssistanceCompany, "슈퍼맨",
			"010-7258-3691"),
