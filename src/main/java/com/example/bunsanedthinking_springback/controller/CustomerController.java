...
public class CustomerController {
	...
	public ArrayList<Contract> getAllContractByCustomerId(@RequestParam int id) throws
	...
	public ArrayList<Contract> getAllContractByProductId(@RequestParam int id) throws
		NotExistContractException,
		NotExistException {
	...
	public Contract getContractByOneAutomobileId(@RequestParam int id) throws
		NotExistContractException,
		NotExistException {
