...
import com.example.bunsanedthinking_springback.repository.EndorsmentMapper;
...
public class CustomerModel {
	...
	public void applyEndorsement(int index, int contractId) throws NotExistContractException, NotExistException {
		...
		if (endorsementVO == null)
			endorsmentMapper.addById_Customer(contractId);
	...
	public ArrayList<Loan> getAllLoan() {
		...
		for (LoanVO loanVO : loanVOS) {
			...
			// InsuranceContractVO
			InsuranceContractVO insuranceContractVO = insuranceContractMapper.getInsuranceContractById_Customer(
				product_id).orElse(null);
